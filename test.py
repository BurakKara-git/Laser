...
def extractor():
    ...
    axisy.move_absolute(50, Units.LENGTH_MILLIMETRES)
...
if __name__ == "__main__":
    ...
    with Connection.open_iot("ae28609e-18a4-4b28-8d89-30c567001c23", token="VJ_GV-w4_fYUQiI8zrSpz2F6Bh2ZLpCF") as connection:
        delete_list = []
        window = Tk()
        ...
        set_initial_rot = EntryWithPlaceholder(window, 0, "Rotation", 4, 0)
        set_y_increament = EntryWithPlaceholder(window, 0.5, "Y Increament", 5, 0)
